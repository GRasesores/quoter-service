...
app.post("/cotizar", async (req, res) => {
  ...
  try {
    ...
    await page.getByText("Datos del Cliente", { exact: true }).click();
    ...
    await page.getByText("Datos de la Unidad", { exact: true }).click();
    ...
    await page.getByText("Detalles de Cobertura", { exact: true }).click();
    ...
    await page.getByText("Información de la Cotización", { exact: true }).click();
